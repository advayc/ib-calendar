...
const MonthNavigation: React.FC<MonthNavigationProps> = ({
  ...
  return (
    <div className={`flex items-center justify-between h-14 px-4 select-none border-b ${isLight ? 'bg-white border-gray-200' : 'bg-[#0d0e0f] border-[#1e2022]'}`}>
      <div className="flex items-center gap-2">
        ...
        <h1 className={`ml-4 text-[28px] font-semibold tracking-tight ${isLight ? 'text-gray-800' : 'text-gray-100'}`}>
